...
void EventAction::EndOfEventAction(const G4Event* event)
{
  ...
  //<< G4BestUnit(_steppingAction->EnergyTop,"Energy")
  //<< "       total track length: " << std::setw(7)
  //<< G4BestUnit(_steppingAction->TrackLTop,"Length")
  //<< G4endl
  //<< "        Gap: total energy: " << std::setw(7)
  //<< G4BestUnit(_steppingAction->EnergyBot,"Energy")
  //<< "       total track length: " << std::setw(7)
  //<< G4BestUnit(_steppingAction->TrackLBot,"Length")
  //<< G4endl;
}
